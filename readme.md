...
##### 5.1. Кэшируются результаты запросов администратора на получение списка ресторанов (пункт API: 3.1.), на 1 час, до 100 запросов.

##### 5.2. Кэшируются результаты запросов администратора на получение ресторанов (пункты API: 3.2.), на 1 час, до 100 запросов.
...
Очистка всех кэшей производится при создании (кроме кэша 5.2.), обновлении и удалении ресторанов (пункты API: 3.10., 3.11. и 3.12.).
